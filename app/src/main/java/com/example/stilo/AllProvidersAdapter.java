...
public class AllProvidersAdapter extends RecyclerView.Adapter<AllProvidersAdapter.ProviderViewHolder> {

    public final Context context;
    public final List<Provider> providerList;
    public final OnProviderClickListener listener;

    public interface OnProviderClickListener {
        void onProviderClick(Provider provider);
    }

    public AllProvidersAdapter(Context context, List<Provider> providerList, OnProviderClickListener listener) {
